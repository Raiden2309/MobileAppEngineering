...
class BottomNavBar extends StatelessWidget {
  ...
  List<Widget> _lecturerItems() => [
    item(Icons.grid_view_rounded,      'Dashboard',  currentIndex == 0),
    item(Icons.class_outlined,         'Classes',    currentIndex == 1),
    item(Icons.bar_chart_rounded,      'Engagement', currentIndex == 2),
    item(Icons.notifications_outlined, 'Alerts',     currentIndex == 3),
  ];
  ...
  Widget build(BuildContext context) {
    return CurvedNavigationBar(
      ...
      items: role == 2 ? _lecturerItems() : _studentItems(),
    );
  }
}