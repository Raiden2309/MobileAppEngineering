...
class LecturerGenerateProfile extends StatefulWidget {
  final VoidCallback onDone;
  const LecturerGenerateProfile({super.key, required this.onDone});

  @override
  State<LecturerGenerateProfile> createState() => _LecturerGenerateProfileState();
}

class _LecturerGenerateProfileState extends State<LecturerGenerateProfile> {
  double _progress = 0;
  int _messageIndex = 0;

  static const _messages = [
    'Saving your profile details…',
    'Registering your subject…',
    'Generating your class join code…',
