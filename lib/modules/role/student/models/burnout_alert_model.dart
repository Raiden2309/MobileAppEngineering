...
class BurnoutAlertModel {
  ...
  factory BurnoutAlertModel.fromJson(Map<String, dynamic> json) {
    return BurnoutAlertModel(
      ...
      workloadLevel: WorkloadLevel.values.byName(
        json['workload_level'] as String,
      ),
  ...
  factory BurnoutAlertModel.burnoutPreset({
    double hoursStudied = 5.5,
  }) => BurnoutAlertModel(
    type: BurnoutAlertType.burnout,
    title: 'Burnout Alert',
    description:
        "You've been studying for 5+ hours today with few breaks, and your task completion has slowed down. Your body and mind need a rest.\n\nIt's recommended to take a longer break or stop studying for the day. Your plan will be adjusted for tomorrow.",
  ...
  factory BurnoutAlertModel.allGoodPreset({
    double hoursStudied = 1.5,
  }) => BurnoutAlertModel(
    type: BurnoutAlertType.allGood,
    title: "You're on Fire!",
    description:
        "Great momentum today! You've completed your tasks efficiently and taken regular breaks. Keep up the excellent pace — your study plan is right on track.",
    hoursStudied: hoursStudied,
  ...
  factory BurnoutAlertModel.warningPreset({
    double hoursStudied = 3.5,
  }) => BurnoutAlertModel(
    type: BurnoutAlertType.warning,
    title: 'Heads Up',
    description:
        "You've been at it for a while. Your focus might start dipping soon. Consider taking a short 10–15 min break to recharge before continuing.",
    hoursStudied: hoursStudied,
  ...
  factory BurnoutAlertModel.overloadPreset({
    double hoursStudied = 7.0,
  }) => BurnoutAlertModel(
    type: BurnoutAlertType.overload,
    title: 'Overload Detected',
    description:
        "You've pushed really hard today — way beyond your usual limit. Studying more now is likely counterproductive. Rest is part of learning. Call it a day.",
    hoursStudied: hoursStudied,
