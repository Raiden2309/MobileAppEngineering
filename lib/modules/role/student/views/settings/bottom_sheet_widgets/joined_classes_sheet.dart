...
class _JoinedClassesSheetState extends State<JoinedClassesSheet> {
  ...
  Future<void> _joinClass() async {
    ...
    await StudentSettingsController.joinClass(context, code);
    _codeController.clear();
    setState(() => _joining = false);
  }

  Future<void> _leaveClass(String classId) async {
    await StudentSettingsController.leaveClass(context, classId);
  }

  @override
  Widget build(BuildContext context) {
    final classes = context.watch<StudentSettingsProvider>().joinedClasses;
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'MY CLASSES',
                style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.legendText, letterSpacing: 0.8),
              ),
              ...
              Expanded(
                child: classes.isEmpty
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.school_outlined, size: 40, color: Colors.white.withOpacity(0.2)),
                  ...
                  separatorBuilder: (_, __) => Divider(height: 1, color: Colors.white.withOpacity(0.07)),
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      leading: Container(
                        ...
                        child: const Icon(Icons.class_rounded, size: 18, color: AppColors.white),
                      ),
                      title: Text(
                        cls.name,
                      ...
                      trailing: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.logout_rounded, size: 14, color: AppColors.red),
                        ),
                      ),
                    );
                  },
  ...
  void _confirmLeave(BuildContext context, String classId, String className) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Leave Class?', style: TextStyle(color: AppColors.white, fontWeight: FontWeight.w700)),
        content: Text(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Leave', style: TextStyle(color: AppColors.red, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
