...
class _BlockedTimesSheetState extends State<BlockedTimesSheet> {
  ...
  void initState() {
    ...
    _slots = Set<String>.from(provider.blockedSlots);

    final dayStart = provider.studyStart;
    final dayEnd = provider.studyEnd;
    _startHour = dayStart.hour;
            ...
            children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            ...List.generate(_days.length, (dIdx) {
                              final key = '${dIdx}_${_startHour + hIdx}';
              ...
              Row(
                children: [
                  ...
                  const Text(
                    'Blocked',
                    style: TextStyle(fontSize: 11, color: AppColors.legendText),
                  ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    await StudentSettingsController.saveBlockedSlots(
                      context,
                      _slots,
                    );
