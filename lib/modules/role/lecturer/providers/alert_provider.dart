...
class AlertProvider extends ChangeNotifier {
  ...
  final List<AlertModel> _alerts = [
    AlertModel(
      ...
      studentId: 'uid_amirul',
      studentName: 'Amirul Haikal',
    ),
    AlertModel(
      type: 'burnout',
      emoji: '🔥',
      ...
      studentId: 'uid_farhana',
      studentName: 'Nurul Farhana',
    ),
    AlertModel(
      type: 'behind',
      emoji: '⚠️',
    ...
    AlertModel(
      ...
      studentId: 'uid_izzati',
      studentName: 'Izzati Roslan',
    ),
    AlertModel(
      type: 'behind',
      emoji: '📋',
    ...
    AlertModel(
      ...
      studentId: 'uid_sitihajar',
      studentName: 'Siti Hajar',
      read: true,
    ),
  ];
